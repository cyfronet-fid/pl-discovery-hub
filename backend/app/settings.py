...
class GlobalSettings(BaseSettings):
    ...
    OIDC_ISSUER: Url = urljoin(OIDC_HOST, "/auth/realms/pl-node")
    OIDC_AUTH_ENDPOINT: str = "/auth/realms/pl-node/protocol/openid-connect/auth"
    OIDC_TOKEN_ENDPOINT: str = "/auth/realms/pl-node/protocol/openid-connect/token"
    OIDC_USERINFO_ENDPOINT: str = "/auth/realms/pl-node/protocol/openid-connect/userinfo"
    OIDC_JWKS_ENDPOINT: str = "/auth/realms/pl-node/protocol/openid-connect/certs"
